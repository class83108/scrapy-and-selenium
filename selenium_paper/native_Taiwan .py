...
class NativeSpider:
    ...
    def get_html(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="ysearchinput0"]').send_keys('台灣土雞')
    ...
    def arrangement(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="research"]').send_keys('台灣土雞')
    ...
    def save_into_mysql(self, item):
        """功能函式-存入mysql資料庫"""
        ins = 'insert into Taiwan_article values(%s, %s, %s, %s, %s, %s)'
        li = [
            item['number'],
            item['url'],
            item['title'],
