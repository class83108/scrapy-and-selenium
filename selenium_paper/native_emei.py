...
class NativeSpider:
    def __init__(self):
        ...
        #redis去重
        self.r = redis.Redis(host = 'localhost', port =6379, db = 5)
        #mysql持久化
    ...
    def get_html(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="ysearchinput0"]').send_keys('峨嵋雞')
    ...
    def arrangement(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="research"]').send_keys('峨嵋雞')
    ...
    def save_into_mysql(self, item):
        """功能函式-存入mysql資料庫"""
        ins = 'insert into emei_article values(%s, %s, %s, %s, %s, %s)'
        li = [
            item['number'],
            item['url'],
            item['title'],
